<?php
	...
	$codex = $_POST['codigoplan']; 
	$sql= sprintf("SELECT * FROM planoensino o INNER JOIN professor r ON r.matricula = o.matricula_professor INNER JOIN disciplina a ON o.codigo_disc = a.codigo INNER JOIN planejamento p ON p.id = o.id WHERE o.codigo = '%s'",$codex);
